    ...
    View findOneVisibleChild(int fromIndex, int toIndex, boolean completelyVisible,
        ...
        if (completelyVisible) {
            ...
            preferredBoundsFlag = (ViewBoundsCheck.FLAG_CVS_LT_PVE
                    | ViewBoundsCheck.FLAG_CVS_EQ_PVE // kg - for visibility of zero-height views at bottom
                    | ViewBoundsCheck.FLAG_CVE_EQ_PVS // kg - for visibility of zero-height views at top?
