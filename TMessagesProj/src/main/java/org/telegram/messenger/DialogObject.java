...
public class DialogObject {
    ...
    public static long getLastMessageOrDraftDate(TLRPC.Dialog dialog, TLRPC.DraftMessage draftMessage, int last_message_date_nb) {
        // kg
        // return draftMessage != null && draftMessage.date >= dialog.last_message_date ? draftMessage.date : dialog.last_message_date;
        int date = dialog.last_message_date;
        if (0 < last_message_date_nb && last_message_date_nb < dialog.last_message_date) {
            date = last_message_date_nb;
        }
        return draftMessage != null && draftMessage.date >= date ? draftMessage.date : date;
    }
